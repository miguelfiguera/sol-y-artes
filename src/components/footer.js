...
background: 'linear-gradient(90deg, rgba(54,8,91,1) 27%, rgba(88,28,135,1) 50%, rgba(54,8,91,1) 71%)'
  }

  return (
    <div className="container-fluid mt-3 border-top border-dark mb-0" style={styling}>
      <div className="row align-items-start mt-3">
        <div className="col text-center">
          <p className="text-light">
            M.F-2023{" "}
            <a href="https://github.com/miguelfiguera" className="text-reset">
              gitHub.com <i className="fa-brands fa-github fa-lg" style={{color:darkOrange}}></i>
            </a>
          </p>
        </div>
        <div className="col text-center">
          <h6 className="text-light">
            ...
            <a href={`https://wa.me/584242341510?text=${text}`}>
              <i className="fa-brands fa-whatsapp fa-lg" style={{color:darkOrange}}></i>{" "}
            </a>
          </h6>
        </div>
        <div className="col text-center">
        ...
        <div className="col text-center">
          <h6 className="text-light">
            Youtube:{" "}
            <a href="https://www.youtube.com/@victorsolla/videos" className="text-reset text-light">
